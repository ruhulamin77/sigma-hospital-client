...
const AboutSigma = () => {
    return (
             ...
             <div className='sigma-about-fild pt-5 '>
               
                 <div className='row mx-2 pt-3   '>
                <div className='col-lg-4 col-md-6 col-sm-12  fild-control'>
                    <p className='about-heding '>About Sigma Central Hospital</p>
                    <h3 className='welcome-msg'>
                        <strong className='bold-welcome'>Welcome To Sigma  </strong> <br /> Central Hospital</h3>
              ...
              <div className='col-lg-4 col-md-6 col-sm-12 fild-control'>
                ...
                <div className='col-lg-4 col-md-6 col-sm-12 image-fild'>
