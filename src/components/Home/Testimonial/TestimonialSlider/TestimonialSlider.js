      ...
      >
        <Carousel.Item>
          ...
          <div className="d-flex align-items-center mt-4">
            <img className="img img-fluid me-4 testimonial-img" src="https://i.ibb.co/nkbvWrW/01.jpg" alt="" />
            <div>
        ...
        <Carousel.Item>
          <p className='lh-2 fz-1 mb-5'>"It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout"</p>
          <div className="d-flex align-items-center mt-4">
            <img className="img img-fluid me-4 testimonial-img" src="https://i.ibb.co/xLr5100/03.jpg" alt="" />
            <div>
