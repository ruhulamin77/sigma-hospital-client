                ...
                <Col lg={8}>
                    {post && <div className="commentForm">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <textarea name="" id="" cols="30" rows="10" {...register("comment", { required: true })}>
                                ...
                                <div key={i} className="comment-post">
                                    ...
                                    <div className="c-post w-100">
                                        <div className="d-flex justify-content-between">
                                            <span>
                                                <span style={{ fontSize: "20px", color: "#7093e5" }}> Comment By</span> <br />
                                                <span style={{}}>{post?.displayName} </span><span style={{ color: "#f68685" }}>{format(post?.time)}</span></span>
                                            <span style={{ fontSize: "20px" }}>Rating <Rating className="rating-color"
