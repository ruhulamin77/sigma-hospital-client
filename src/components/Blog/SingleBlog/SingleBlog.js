...
const SingleBlog = () => {
      ...
      const getvisitor = async () => {
        try {
          const res = await axios.put(
            `https://sigma-hospital-server.onrender.com/totalVisitor/${singleBlog?._id}`,
            userVisit
          );
  ...
  const handleUpdateLike = async (id) => {
    ...
    const res = await axios.put(
      `https://sigma-hospital-server.onrender.com/updateBloglike/${id}`,
      docLike
    );
    if (res.data) {
  ...
  const handleUpdateUnLike = async (id) => {
    ...
    const res = await axios.put(
      `https://sigma-hospital-server.onrender.com/updateBlogUnlike/${id}`,
      docUnLike
    );
    if (res.data) {
