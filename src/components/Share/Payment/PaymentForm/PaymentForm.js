        ...
        <div className="container mt-5 px-5">
            ...
            <form className="row">
                <div className="col-md-12">
                    <div className="card p-3">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                ...
                                <div className="inputbox mt-3 mr-2"> <input type="text" name="name" className="form-control" required="required" /> <span>Month</span>
                                </div>
                            </div>
                            <div className="col-md-6">

                                <div className="inputbox mt-3 mr-2"> <input type="text" name="name" className="form-control" required="required" /> <span>Year</span>
                                </div>
                            </div>
                            <div className="col-md-6">
                    ...
                    <div className="mt-4 mb-4 d-flex justify-content-between"><button className="btn btn-success w-100 mx-5 px-3">Confirm</button> </div>
                </div>
            </form>
        </div>
    );
