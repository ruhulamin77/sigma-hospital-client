                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className='row'>
                                <div className='col-12 col-sm-6 col-md-6 col-lg-6'>
                                    <input className="input-field-name" type="text" {...register("name", { required: true })} defaultValue={singleNurseInfo?.name} />
                                </div>
                                <div className='col-12 col-sm-6 col-md-6 col-lg-6'>
                                    <div className='row'>
                                        <div className='col-12 col-md-6'>
                                            <input className="input-field-name" type="email" {...register("email", { required: true })} defaultValue={singleNurseInfo?.email} />
                                        </div>
                                        <div className='col-12 col-md-6'>
                                            <input className="input-field-name" type="number" {...register("phone", { required: true })} defaultValue={singleNurseInfo?.phone} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className='row mt-3'>
                                <div className='col-12 col-sm-6 col-md-6 col-lg-6'>
                                    <div className='row'>
                                        <div className='col-12 col-md-6'>
                                            <select className="service-doctor" {...register("gender", { required: true })} defaultValue={singleNurseInfo?.gender} >
                                        ...
                                        <div className='col-12 col-md-6'>
                                            <select className="service-doctor" {...register("time", { required: true })} defaultValue={singleNurseInfo?.time} >
                                ...
                                <div className='col-12 col-sm-6 col-md-6 col-lg-6'>
                                    <div className='row'>
                                        <div className='col-12 col-md-6'>
                                            <select className="service-doctor" {...register("day", { required: true })} defaultValue={singleNurseInfo?.day} >
                                        ...
                                        <div className='col-12 col-md-6'>
                                            <select className="service-doctor" {...register("shift", { required: true })} defaultValue={singleNurseInfo?.shift} >
                                ...
                                <div className='col-12 mt-3'>
                                    <input className="input-field-name" type="text" {...register("description", { required: true })} defaultValue={singleNurseInfo?.description} />
                                </div>
                            </div>
