...
const Order = () => {
  ...
  const handelremovecart = (cartItems) => {
    axios
      .put(`https://sigma-hospital-server.onrender.com/medicine`, {
        item: { cartItems },
      })
      .then((data) => {})
      .catch((err) => {
  ...
  const handelPayment = () => {
    ...
    fetch('https://sigma-hospital-server.onrender.com/init', {
      method: 'POST',
      headers: {
  ...
  return (
    <section className="mt-5">
      <div className="container mt-5">
        <span className="user_info">Customer Name :</span>{' '}
        <input
          type="text"
          onBlur={handelname}
          className="cus_info_fild"
          required={true}
        />{' '}
        <br />
        <span className="user_info"> Phone Number :</span>{' '}
        <input
          type="text"
          onBlur={handelnumber}
          className="cus_info_fild"
        ...
        />{' '}
        <br />
        <span className="user_info"> Address :</span>{' '}
        <input
          type="text"
        ...
        <div className="continue-shoping">
          ...
          <div>
            ...
            <div>
              <button onClick={handelPayment} className="payment-btn">
                Payment
              </button>
            </div>
          </div>
